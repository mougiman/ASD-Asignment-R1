...
public class MongoDBConnector {
    ...
    MongoCollection<Document> dbHisotry = shopDB.getCollection("History");
...
public ItemList getItemList(){
    ...
    public User getUser(String ID){
        for (Document doc : users.find()) {
            ...
            System.out.print(id + "------" + ID);
            if(ID.equals(ID)){
                return (new User((String) doc.get("id"), (String) doc.get("name"), (String) doc.get("email"),(String) doc.get("password"), (String) doc.get("phone")));
            }
        }
        return null;
    }
    
 //   public Order getOrderHistory(String ID){
